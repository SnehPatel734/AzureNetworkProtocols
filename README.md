...
<p>
First we need to creare a resource group which is a container that holds Azure resources. For our purposes we are goning to be creating two virtual machines and adding them into this resource group. 
</p>
